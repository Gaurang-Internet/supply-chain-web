...
const NewsMasthead: React.FC<NewsMastheadProps> = ({ searchQuery, onSearchChange, onNavClick, onNavigate }) => {
  ...
  return (
    <div className="bg-white border-b border-gray-100 sticky top-0 z-50">
      <header className="px-4 py-3 md:px-8 md:py-6">
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-6 animate-in slide-in-from-top duration-300 overflow-y-auto max-h-[80vh]">
